...
console.log("Range es el constructor de r: ", r instanceof Range); // true

// Pero Range no es el prototipo de r porque es la constructor function no la Range.prototype
console.log("Range no es el prototipo de r: " + Range.isPrototypeOf(r)); // false

// la propiedad constructor es un objeto, no un string
console.log("Propiedad constructor de Range: " + Range.constructor.toString()); // function Function() { [native code] 
...
*/
console.log("Propiedad class del objeto: " + Object.prototype.toString.call(r).slice(8, -1)); // Object