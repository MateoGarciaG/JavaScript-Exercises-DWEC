...
var extend = function extender(p, o) {
  var names = Object.getOwnPropertyNames(o);
              for(var i = 0; i < names.length; i++) {
                  ...
                  // Agregamos el DESCRIPTOR con la propiedad dentro de "p"
...
console.log("Propiedad class del objeto p: " + Object.prototype.toString.call(p).slice(8, -1)); // Object 
...
console.log("name en p: " + p.meta.name); // delorean
q.meta.name = "doc";
console.log("name en p ha cambiado: " + p.meta.name); // doc
console.log("name en o ha cambiado: " + o.meta.name); // doc
...
console.log("en q meta.name sigue siendo doc: " + q.meta.name); // doc