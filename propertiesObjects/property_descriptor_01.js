...
// Returns {get, set, enumerable:true, configurable:true} -> R si tiene tanto un GET como SET
console.log(Object.getOwnPropertyDescriptor(p, "r"));

// Returns {get, set: undefined, enumerable:true, configurable:true} -> "theta" solo le fue asignada un GET, no un SET
console.log(Object.getOwnPropertyDescriptor(p, "theta"));

// Returns undefined for inherited properties, becaouse "toString" doesn't belong to "p"
