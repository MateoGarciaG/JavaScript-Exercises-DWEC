...
console.log("Keys de x: ninguna " + Object.keys(o)); // => [] -> porque X no es enumerable
...
o.x = 2; // Fails silently or throws TypeError in strict mode, porque "writable: false"
console.log("x sigue siendo 1: " + o.x); // => 1

// La unica forma de cambiarle el valor es modificando el atributo "value"
// del property DESCRIPTOR de la propiedad "x", esto aún no los permite
// debido a "configurable: true"
...
console.log("get() x : " + o.x); // => 0 -> Llama al accessor GET

// al crear una propiedad, que sucede con los atributos que no especificas?
Object.defineProperty(o, "y", {});
console.log("y: " + o.y); // y: undefined -> porque no se le dio nungún valor pero el DESCRIPTOR aunque lo hayamos colocado vacío, los atributos se settearán por defecto a:
