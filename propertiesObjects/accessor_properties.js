...
console.log("actual r = " + p.r); // actual r = 1.4142135623730951
p.r =2;
console.log("new r = " + p.r); // new r = 1.9999999999999998
console.log("actual x is not 1: " + p.x); // actual x is not 1: 1.414213562373095
console.log("theta : " + p.theta); // theta : 0.7853981633974483