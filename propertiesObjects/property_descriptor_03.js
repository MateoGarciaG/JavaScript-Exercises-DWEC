...
// x es writable aunque no sea configurable, esto quiere decir
// que ya no podremos volver a modificar las porpiedades
// enumerable y configurable del DESCRIPTOR de "o.x" pero SI podemos modificar SOLO UNA VEZ MÁS "writable" Y SOLO A FALSE
o.x = 2;
console.log("x write a 2: " + o.x); // x write a 2: 2

// cambio x a read only aunque no sea configurable
Object.defineProperty(o, "x",  { writable: false });
o.x = 3;
console.log("x writable false: " + o.x); // x writable false: 2

// si no es configurable no puedo volver cambiar a writable a TRUE
...
console.log("r es data property ahora: " + o.r); // r es data property ahora: 1

// si data property es configurable puedo hacerla accessor
Object.defineProperty(o, "y", {get: function() { return 0; } } );
console.log("y es get: " + o.y); // y es get: 0
